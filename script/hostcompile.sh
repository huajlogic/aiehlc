...
${TOOL_PREFIX}g++ ${OPT_FLAGS} -o host host.o aie_runtime.o aie_runtime_debug.o aie_runtime_stream_debug.o aie_runtime_common.o aie_runtime_control_plan.o ${ROUTING_OBJ} ${KERNEL_OBJ_LIST} \
    --specs=nosys.specs \
