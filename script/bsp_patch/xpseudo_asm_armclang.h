...
#define ldr(adr)                                                                                                       \
    ({                                                                                                                 \
        u64 rval;                                                                                                      \
        __asm__ __volatile__("ldr %x0, [%x1]" : "=r"(rval) : "r"(adr));                                                \
        rval;                                                                                                          \
    })
...
#define ldrb(adr)                                                                                                      \
    ({                                                                                                                 \
        u8 rval;                                                                                                       \
        __asm__ __volatile__("ldrb %x0, [%x1]" : "=r"(rval) : "r"(adr));                                               \
        rval;                                                                                                          \
    })

#define strw(adr, val) __asm__ __volatile__("str %x0, [%x1]\n" : : "r"(val), "r"(adr))

#define strb(adr, val) __asm__ __volatile__("strb	%x0,[%x1]\n" : : "r"(val), "r"(adr))

/* Count leading zeroes (clz) */
#define clz(arg)                                                                                                       \
    ({                                                                                                                 \
        u8 rval;                                                                                                       \
        __asm__ __volatile__("clz %x0, %x1" : "=r"(rval) : "r"(arg));                                                  \
        rval;                                                                                                          \
    })
...
#define mfcp(reg)                                                                                                      \
    ({                                                                                                                 \
        u64 rval = 0U;                                                                                                 \
        __asm__ __volatile__("mrs %x0, " #reg : "=r"(rval));                                                           \
        rval;                                                                                                          \
    })

#define mfcpnotoken(reg)                                                                                               \
    ({                                                                                                                 \
        u64 rval = 0U;                                                                                                 \
