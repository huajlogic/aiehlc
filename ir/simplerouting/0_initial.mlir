module attributes {codegen.headers = ["stdint.h", "stdio.h", "custom_lib.h"], routing.effective_k = 16 : i64, routing.full_k = 64 : i64, routing.k_rounds = 4 : i64, routing.m_rounds = 2 : i64, routing.n_rounds = 2 : i64, routing.pp_depth_map = {tensor_0 = 2 : i32, tensor_1 = 2 : i32, tensor_2 = 2 : i32}, routing.tile_cols = 16 : i64, routing.tile_m = 8 : i64, routing.tile_n = 8 : i64, routing.tile_rows = 16 : i64} {
  func.func @routing(%arg0: !emitc.ptr<!emitc.opaque<"XAie_DevInst">>, %arg1: memref<64x64xi8>, %arg2: memref<64x64xi8>, %arg3: memref<64x64xi8>) {
    %c3_i32 = arith.constant 3 : i32
    %c2_i32 = arith.constant 2 : i32
    %c1_i32 = arith.constant 1 : i32
    %c0_i32 = arith.constant 0 : i32
    %0 = bufferization.to_tensor %arg1 : memref<64x64xi8>
    %1 = routing.routingcreatescheduletensor %0 : tensor<64x64xi8> shape = [64, 64], dim = 2 -> tensor<64x64xi8>
    %2 = bufferization.to_tensor %arg2 : memref<64x64xi8>
    %3 = routing.routingcreatescheduletensor %2 : tensor<64x64xi8> shape = [64, 64], dim = 2 -> tensor<64x64xi8>
    %4 = bufferization.to_tensor %arg3 : memref<64x64xi8>
    %5 = routing.routingcreatescheduletensor %4 : tensor<64x64xi8> shape = [64, 64], dim = 2 -> tensor<64x64xi8>
    scf.execute_region {
      ...
      ^bb0(%arg4: i32):
        %11 = routing.routingextract_data %6, %arg4 : tensor<64x64xi8>, i32 -> tensor<16x64xi8>
        ...
        dmaphop.push %11 into %35 consumer(%11, %11, %11, %11 at %13, %16, %19, %22) : tensor<16x64xi8> !dmaphop.path tensor<16x64xi8>, tensor<16x64xi8>, tensor<16x64xi8>, tensor<16x64xi8> !dmaphop.port, !dmaphop.port, !dmaphop.port, !dmaphop.port
        dmaphop.sync %35
        "routing.yield"() : () -> ()
      }
    ...
    scf.execute_region {
      ...
      ^bb0(%arg4: i32):
        %12 = routing.routingextract_data %6, %arg4 : tensor<64x64xi8>, i32 -> tensor<16x64xi8>
        ...
        dmaphop.push %12 into %36 consumer(%12, %12, %12, %12 at %14, %17, %20, %23) : tensor<16x64xi8> !dmaphop.path tensor<16x64xi8>, tensor<16x64xi8>, tensor<16x64xi8>, tensor<16x64xi8> !dmaphop.port, !dmaphop.port, !dmaphop.port, !dmaphop.port
        dmaphop.sync %36
        %37 = routing.routingextract_data %7, %arg4 : tensor<64x64xi8>, i32 -> tensor<16x64xi8>
        ...
        %extracted_slice = tensor.extract_slice %37[0, 0] [4, 64] [1, 1] {tag = "producer0"} : tensor<16x64xi8> to tensor<4x64xi8>
        %extracted_slice_0 = tensor.extract_slice %37[4, 0] [4, 64] [1, 1] {tag = "producer1"} : tensor<16x64xi8> to tensor<4x64xi8>
        %extracted_slice_1 = tensor.extract_slice %37[8, 0] [4, 64] [1, 1] {tag = "producer2"} : tensor<16x64xi8> to tensor<4x64xi8>
        %extracted_slice_2 = tensor.extract_slice %37[12, 0] [4, 64] [1, 1] {tag = "producer3"} : tensor<16x64xi8> to tensor<4x64xi8>
        dmaphop.pull %37 from %61 producer(%extracted_slice, %extracted_slice_0, %extracted_slice_1, %extracted_slice_2 at %39, %42, %45, %48) : tensor<16x64xi8> !dmaphop.path tensor<4x64xi8>, tensor<4x64xi8>, tensor<4x64xi8>, tensor<4x64xi8> !dmaphop.port, !dmaphop.port, !dmaphop.port, !dmaphop.port
        dmaphop.sync %61
        "routing.yield"() : () -> ()
      }
