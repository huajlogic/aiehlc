module attributes {codegen.headers = ["stdint.h", "stdio.h", "custom_lib.h"], routing.pp_depth_map = {tensor_0 = 2 : i32, tensor_1 = 2 : i32, tensor_2 = 2 : i32}} {
  func.func @routing(%arg0: !emitc.ptr<!emitc.opaque<"XAie_DevInst">>, %arg1: memref<32xi8>, %arg2: memref<9286xi8>, %arg3: memref<32xi8>) {
    ...
    %2 = bufferization.to_tensor %arg2 : memref<9286xi8>
    %3 = routing.routingcreatescheduletensor %2 : tensor<9286xi8> shape = [9286], dim = 1 -> tensor<9286xi8>
    %4 = bufferization.to_tensor %arg3 : memref<32xi8>
  ...
  partition = #routing.partition<splitnum = 2, splitdim = 0, hwAxisOwner = "col", replicateOn = "row", singleTileOwner = "">
      ...
      ^bb0(%arg4: i32):
        %9 = routing.routingextract_data %6, %arg4 : tensor<9286xi8>, i32 -> tensor<4643xi8>
  ...
  partition = #routing.partition<splitnum = 2, splitdim = 0, hwAxisOwner = "row", replicateOn = "col", singleTileOwner = "">
      ...
      ^bb0(%arg4: i32):
        %10 = routing.routingextract_data %6, %arg4 : tensor<32xi8>, i32 -> tensor<16xi8>
        ...
        dmaphop.sync %24
        %25 = routing.routingextract_data %7, %arg4 : tensor<32xi8>, i32 -> tensor<16xi8>
