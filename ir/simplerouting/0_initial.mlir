module attributes {codegen.headers = ["stdint.h", "stdio.h", "custom_lib.h"], routing.effective_k = 64 : i64, routing.full_k = 512 : i64, routing.k_rounds = 8 : i64, routing.pp_depth_map = {tensor_0 = 2 : i32, tensor_1 = 2 : i32, tensor_2 = 2 : i32}} {
  func.func @routing(%arg0: !emitc.ptr<!emitc.opaque<"XAie_DevInst">>, %arg1: memref<512x512xi8>, %arg2: memref<512x512xi8>, %arg3: memref<512x512xi8>) {
    ...
    %2 = bufferization.to_tensor %arg2 : memref<512x512xi8>
    %3 = routing.routingcreatescheduletensor %2 : tensor<512x512xi8> shape = [512, 512], dim = 2 -> tensor<512x512xi8>
    %4 = bufferization.to_tensor %arg3 : memref<512x512xi8>
    ...
    scf.execute_region {
      ...
      ^bb0(%arg4: i32):
        %11 = routing.routingextract_data %6, %arg4 : tensor<512x512xi8>, i32 -> tensor<128x512xi8>
    ...
    scf.execute_region {
      ...
      ^bb0(%arg4: i32):
        %12 = routing.routingextract_data %6, %arg4 : tensor<512x512xi8>, i32 -> tensor<128x512xi8>
        ...
        dmaphop.sync %36
        %37 = routing.routingextract_data %7, %arg4 : tensor<512x512xi8>, i32 -> tensor<128x512xi8>
