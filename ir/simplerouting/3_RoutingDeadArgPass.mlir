...
module attributes {codegen.headers = ["stdint.h", "stdio.h", "custom_lib.h"]} {
  func.func @routing() {
    ...
    emitc.if %30 {
      ...
      %66 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %67 = emitc.call @XAie_StrmConnCctEnable(%66, %65, %26, %32, %25, %33) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
      %68 = emitc.call @XAie_TileLoc(%32, %23) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %69 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      ...
      %75 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %76 = emitc.call @XAie_StrmConnCctEnable(%75, %74, %26, %34, %28, %34) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
    ...
    emitc.if %30 {
      ...
      %66 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %67 = emitc.call @XAie_StrmConnCctEnable(%66, %65, %28, %32, %27, %33) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
      %68 = emitc.call @XAie_TileLoc(%32, %23) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %69 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %70 = emitc.call @XAie_StrmConnCctEnable(%69, %68, %28, %32, %25, %33) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
      %71 = emitc.call @XAie_TileLoc(%33, %23) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %72 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %73 = emitc.call @XAie_StrmConnCctEnable(%72, %71, %26, %33, %27, %33) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
      %74 = emitc.call @XAie_TileLoc(%33, %23) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %75 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %76 = emitc.call @XAie_StrmConnCctEnable(%75, %74, %26, %33, %25, %33) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
      %77 = emitc.call @XAie_TileLoc(%34, %23) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %78 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
    ...
    emitc.if %30 {
      ...
      %68 = emitc.call @XAie_TileLoc(%32, %23) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %69 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %70 = emitc.call @XAie_StrmConnCctEnable(%69, %68, %26, %34, %27, %32) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
      %71 = emitc.call @XAie_TileLoc(%32, %23) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %72 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      ...
      %74 = emitc.call @XAie_TileLoc(%33, %23) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %75 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %76 = emitc.call @XAie_StrmConnCctEnable(%75, %74, %26, %32, %27, %32) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
      %77 = emitc.call @XAie_TileLoc(%33, %23) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %78 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %79 = emitc.call @XAie_StrmConnCctEnable(%78, %77, %26, %32, %29, %34) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
    ...
    emitc.if %30 {
      ...
      %65 = emitc.call @XAie_TileLoc(%32, %23) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %66 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %67 = emitc.call @XAie_StrmConnCctEnable(%66, %65, %26, %33, %27, %31) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
      %68 = emitc.call @XAie_TileLoc(%33, %23) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %69 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %70 = emitc.call @XAie_StrmConnCctEnable(%69, %68, %26, %31, %27, %31) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
      %71 = emitc.call @XAie_TileLoc(%34, %23) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %72 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %73 = emitc.call @XAie_StrmConnCctEnable(%72, %71, %26, %31, %29, %31) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
      %74 = emitc.call @XAie_TileLoc(%34, %22) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %75 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %76 = emitc.call @XAie_StrmConnCctEnable(%75, %74, %28, %31, %29, %33) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
      %77 = emitc.call @XAie_TileLoc(%34, %21) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %78 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %79 = emitc.call @XAie_StrmConnCctEnable(%78, %77, %28, %33, %26, %33) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
      %80 = emitc.call @XAie_TileLoc(%34, %21) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %81 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %82 = emitc.call @XAie_StrmConnCctEnable(%81, %80, %28, %33, %25, %33) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
      %83 = emitc.call @XAie_TileLoc(%33, %21) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %84 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %85 = emitc.call @XAie_StrmConnCctEnable(%84, %83, %27, %33, %26, %33) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
      %86 = emitc.call @XAie_TileLoc(%33, %21) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %87 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %88 = emitc.call @XAie_StrmConnCctEnable(%87, %86, %27, %33, %25, %33) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
      %89 = emitc.call @XAie_TileLoc(%32, %21) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %90 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %91 = emitc.call @XAie_StrmConnCctEnable(%90, %89, %27, %33, %26, %33) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
      %92 = emitc.call @XAie_TileLoc(%32, %21) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %93 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %94 = emitc.call @XAie_StrmConnCctEnable(%93, %92, %27, %33, %25, %33) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32) -> i32
    ...
    emitc.if %30 {
      ...
      %38 = emitc.call @XAie_StrmPktSwSlavePortEnable(%36, %35, %25, %34) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32) -> i32
      %39 = emitc.call @XAie_StrmPktSwMstrPortEnable(%36, %35, %26, %32, %16, %34, %33) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32, i32) -> i32
      %40 = emitc.call @XAie_TileLoc(%33, %21) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %41 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %42 = emitc.call @XAie_StrmPktSwSlaveSlotEnable(%41, %40, %27, %32, %34, %20, %34, %34, %34) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, i32, !emitc.opaque<"XAie_Packet">, i32, i32, i32) -> i32
      %43 = emitc.call @XAie_StrmPktSwSlavePortEnable(%41, %40, %27, %32) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32) -> i32
      ...
      %45 = emitc.call @XAie_StrmPktSwSlavePortEnable(%41, %40, %25, %34) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32) -> i32
      %46 = emitc.call @XAie_StrmPktSwMstrPortEnable(%41, %40, %26, %32, %16, %34, %33) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, !emitc.ptr<i8>, i32, i32) -> i32
      %47 = emitc.call @XAie_TileLoc(%32, %21) : (i32, i32) -> !emitc.opaque<"XAie_LocType">
      %48 = emitc.call @getOrCreateDeviceInstance() : () -> !emitc.ptr<!emitc.opaque<"XAie_DevInst">>
      %49 = emitc.call @XAie_StrmPktSwSlaveSlotEnable(%48, %47, %27, %32, %34, %20, %34, %34, %34) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32, i32, !emitc.opaque<"XAie_Packet">, i32, i32, i32) -> i32
      %50 = emitc.call @XAie_StrmPktSwSlavePortEnable(%48, %47, %27, %32) : (!emitc.ptr<!emitc.opaque<"XAie_DevInst">>, !emitc.opaque<"XAie_LocType">, !emitc.ptr<i8>, i32) -> i32
