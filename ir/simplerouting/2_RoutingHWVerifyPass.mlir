module attributes {codegen.headers = ["stdint.h", "stdio.h", "custom_lib.h"], routing.pp_depth_map = {tensor_0 = 2 : i32, tensor_1 = 2 : i32, tensor_2 = 2 : i32}} {
  func.func @routing(%arg0: !emitc.ptr<!emitc.opaque<"XAie_DevInst">>, %arg1: memref<256xi8>, %arg2: memref<158xi8>, %arg3: memref<256xi8>) {
    ...
    %1 = bufferization.to_tensor %arg2 : memref<158xi8>
    %2 = bufferization.to_tensor %arg3 : memref<256xi8>
    scf.execute_region {
      ...
      ^bb0(%arg4: i32):
        ...
        %7 = routinghw.ioshimtilecreate {IOID = 55 : i32, channelused = 0 : i32, col = 2 : i32, comments = "shim_dma_55", dmadirection = 0 : i32, row = 0 : i32} -> i32
      ...
      ^bb0(%arg4: i32):
        ...
        %7 = routinghw.ioshimtilecreate {IOID = 56 : i32, channelused = 1 : i32, col = 2 : i32, comments = "shim_dma_56", dmadirection = 0 : i32, row = 0 : i32} -> i32
        %8 = routinghw.tilecreate {col = 2 : i32, comments = "tile in path", row = 0 : i32} -> i32
        %9 = routinghw.tilecreate {col = 2 : i32, comments = "tile in path", row = 1 : i32} -> i32
        %10 = routinghw.tilecreate {col = 2 : i32, comments = "tile in path", row = 2 : i32} -> i32
        %11 = routinghw.tilecreate {col = 2 : i32, comments = "tile in path", row = 3 : i32} -> i32
    ...
    scf.execute_region {
      ...
      ^bb0(%arg4: i32):
        ...
        %7 = routinghw.ioshimtilecreate {IOID = 57 : i32, channelused = 0 : i32, col = 3 : i32, comments = "shim_dma_57", dmadirection = 0 : i32, row = 0 : i32} -> i32
        ...
        %24 = routinghw.ioshimtilecreate {IOID = 58 : i32, channelused = 0 : i32, col = 2 : i32, comments = "shim_dma_58", dmadirection = 1 : i32, row = 0 : i32} -> i32
      ...
      ^bb0(%arg4: i32):
        ...
        %6 = routinghw.tilecreate {col = 1 : i32, comments = "core_tile", row = 4 : i32} -> i32
        %7 = routinghw.ioshimtilecreate {IOID = 59 : i32, channelused = 1 : i32, col = 3 : i32, comments = "shim_dma_59", dmadirection = 0 : i32, row = 0 : i32} -> i32
        %8 = routinghw.tilecreate {col = 3 : i32, comments = "tile in path", row = 0 : i32} -> i32
        %9 = routinghw.tilecreate {col = 3 : i32, comments = "tile in path", row = 1 : i32} -> i32
        %10 = routinghw.tilecreate {col = 3 : i32, comments = "tile in path", row = 2 : i32} -> i32
        %11 = routinghw.tilecreate {col = 3 : i32, comments = "tile in path", row = 3 : i32} -> i32
        ...
        %26 = routinghw.ioshimtilecreate {IOID = 60 : i32, channelused = 1 : i32, col = 2 : i32, comments = "shim_dma_60", dmadirection = 1 : i32, row = 0 : i32} -> i32
