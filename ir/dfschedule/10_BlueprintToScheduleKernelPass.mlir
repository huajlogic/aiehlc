module attributes {codegen.headers = ["stdint.h", "stdio.h", "custom_lib.h"], routing.pp_depth_map = {tensor_0 = 2 : i32, tensor_1 = 2 : i32, tensor_2 = 2 : i32}} {
  dfschedule.module @kernel_driver_dskernel_receiver {
    ...
    dfschedule.buffer_def @buf_in_ping_0 : memref<1024xvector<4xi8>, "LOCAL"> {address = 477184 : i64}
    dfschedule.buffer_def @buf_in_pong_0 : memref<1024xvector<4xi8>, "LOCAL"> {address = 481280 : i64}
    ...
    dfschedule.buffer_def @buf_in_ping_1 : memref<1024xvector<4xi8>, "LOCAL"> {address = 468992 : i64}
    dfschedule.buffer_def @buf_in_pong_1 : memref<1024xvector<4xi8>, "LOCAL"> {address = 473088 : i64}
    ...
    dfschedule.buffer_def @buf_out_ping_0 : memref<512xvector<4xi8>, "LOCAL"> {address = 485376 : i64}
    dfschedule.buffer_def @buf_out_pong_0 : memref<512xvector<4xi8>, "LOCAL"> {address = 489472 : i64}
