module attributes {codegen.headers = ["stdint.h", "stdio.h", "custom_lib.h"], routing.pp_depth_map = {tensor_0 = 2 : i32, tensor_1 = 2 : i32, tensor_2 = 1 : i32}} {
  dfschedule.module @kernel_driver_dskernel_receiver {
    ...
    dfschedule.buffer_def @buf_out_pong_0 : memref<1024xvector<4xi8>, "LOCAL">
    dfschedule.window_def @window_out_0 {acquire_lock = @LOCK_window_out_0_ACQ, async = true, buffer_size = 1024 : i32, direction = "out", num_rounds = 1 : i32, ping_buffer = @buf_out_ping_0, pong_buffer = @buf_out_pong_0, release_lock = @LOCK_window_out_0_REL}
