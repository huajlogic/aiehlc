module attributes {codegen.headers = ["stdint.h", "stdio.h", "custom_lib.h"], routing.effective_k = 64 : i64, routing.full_k = 4096 : i64, routing.k_rounds = 64 : i64, routing.m_rounds = 64 : i64, routing.n_rounds = 64 : i64, routing.pp_depth_map = {tensor_0 = 2 : i32, tensor_1 = 2 : i32, tensor_2 = 2 : i32}, routing.tile_cols = 1024 : i64, routing.tile_m = 16 : i64, routing.tile_n = 16 : i64, routing.tile_rows = 1024 : i64} {
  func.func @main(%arg0: memref<4096x4096xi8>, %arg1: memref<4096x4096xi8>, %arg2: memref<4096x4096xi8>) {
    ...
    scf.execute_region {
      ...
      ^bb0(%arg3: i32):
        %11 = routing.routingextract_data %6, %arg3 : tensor<4096x4096xi8>, i32 -> tensor<1024x4096xi8>
    ...
    scf.execute_region {
      ...
      ^bb0(%arg3: i32):
        %12 = routing.routingextract_data %6, %arg3 : tensor<4096x4096xi8>, i32 -> tensor<1024x4096xi8>
        ...
        dmaphop.sync %36
        %37 = routing.routingextract_data %7, %arg3 : tensor<4096x4096xi8>, i32 -> tensor<1024x4096xi8>
