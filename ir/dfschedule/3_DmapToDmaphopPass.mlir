module attributes {codegen.headers = ["stdint.h", "stdio.h", "custom_lib.h"], routing.effective_k = 64 : i64, routing.full_k = 512 : i64, routing.k_rounds = 8 : i64, routing.m_rounds = 8 : i64, routing.n_rounds = 8 : i64, routing.pp_depth_map = {tensor_0 = 2 : i32, tensor_1 = 2 : i32, tensor_2 = 2 : i32}, routing.tile_cols = 128 : i64, routing.tile_m = 16 : i64, routing.tile_n = 16 : i64, routing.tile_rows = 128 : i64} {
  func.func @main(%arg0: memref<512x512xi8>, %arg1: memref<512x512xi8>, %arg2: memref<512x512xi8>) {
    ...
    %1 = routing.routingcreatescheduletensor %0 : tensor<512x512xi8> shape = [512, 512], dim = 2 -> tensor<512x512xi8>
    %2 = bufferization.to_tensor %arg1 : memref<512x512xi8>
    %3 = routing.routingcreatescheduletensor %2 : tensor<512x512xi8> shape = [512, 512], dim = 2 -> tensor<512x512xi8>
    %4 = bufferization.to_tensor %arg2 : memref<512x512xi8>
    %5 = routing.routingcreatescheduletensor %4 : tensor<512x512xi8> shape = [512, 512], dim = 2 -> tensor<512x512xi8>
    scf.execute_region {
      ...
      ^bb0(%arg3: i32):
        %11 = routing.routingextract_data %6, %arg3 : tensor<512x512xi8>, i32 -> tensor<128x512xi8>
        ...
        dmaphop.push %11 into %35 consumer(%11, %11, %11, %11 at %13, %16, %19, %22) : tensor<128x512xi8> !dmaphop.path tensor<128x512xi8>, tensor<128x512xi8>, tensor<128x512xi8>, tensor<128x512xi8> !dmaphop.port, !dmaphop.port, !dmaphop.port, !dmaphop.port
        dmaphop.sync %35
        "routing.yield"() : () -> ()
      }
    ...
    scf.execute_region {
      ...
      ^bb0(%arg3: i32):
        %12 = routing.routingextract_data %6, %arg3 : tensor<512x512xi8>, i32 -> tensor<128x512xi8>
        ...
        dmaphop.push %12 into %36 consumer(%12, %12, %12, %12 at %14, %17, %20, %23) : tensor<128x512xi8> !dmaphop.path tensor<128x512xi8>, tensor<128x512xi8>, tensor<128x512xi8>, tensor<128x512xi8> !dmaphop.port, !dmaphop.port, !dmaphop.port, !dmaphop.port
        dmaphop.sync %36
        %37 = routing.routingextract_data %7, %arg3 : tensor<512x512xi8>, i32 -> tensor<128x512xi8>
        ...
        %extracted_slice = tensor.extract_slice %37[0, 0] [32, 512] [1, 1] {tag = "producer0"} : tensor<128x512xi8> to tensor<32x512xi8>
        %extracted_slice_0 = tensor.extract_slice %37[32, 0] [32, 512] [1, 1] {tag = "producer1"} : tensor<128x512xi8> to tensor<32x512xi8>
        %extracted_slice_1 = tensor.extract_slice %37[64, 0] [32, 512] [1, 1] {tag = "producer2"} : tensor<128x512xi8> to tensor<32x512xi8>
        %extracted_slice_2 = tensor.extract_slice %37[96, 0] [32, 512] [1, 1] {tag = "producer3"} : tensor<128x512xi8> to tensor<32x512xi8>
        dmaphop.pull %37 from %61 producer(%extracted_slice, %extracted_slice_0, %extracted_slice_1, %extracted_slice_2 at %39, %42, %45, %48) : tensor<128x512xi8> !dmaphop.path tensor<32x512xi8>, tensor<32x512xi8>, tensor<32x512xi8>, tensor<32x512xi8> !dmaphop.port, !dmaphop.port, !dmaphop.port, !dmaphop.port
        dmaphop.sync %61
        "routing.yield"() : () -> ()
      }
