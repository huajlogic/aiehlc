  ...
  func.func @main(%arg0: memref<16x16xi8>, %arg1: memref<16x16xi8>, %arg2: memref<16x16xi8>) {
    ...
    scf.execute_region {
      ...
      ^bb0(%arg3: i32):
        ...
        %14 = routing.routingextract_data %8, %arg3 : tensor<16x16xi8>, i32 -> tensor<4x16xi8>
        %15 = routing.routingcreatehwiowithtarget targettilelist = %13 : i32 {direction = "input", iotype = "mem2"} -> i32
        %16 = routing.routingmovedatabyio tensordata = %14, hwiowithtarget = %15 : tensor<4x16xi8>, i32 -> i32
        "routing.yield"() : () -> ()
      }
    ...
    scf.execute_region {
      ...
      %9 = routing.partitiontensor tensor = %6 : tensor<16x16xi8> {
          splitnum = 4,
          splitdim = 0,
          hw_axis_owner = "row",
          replicate_on = "col",
      ...
      ^bb0(%arg3: i32):
        ...
        %15 = routing.routingextract_data %8, %arg3 : tensor<16x16xi8>, i32 -> tensor<4x16xi8>
        ...
        %18 = routing.routingextract_data %9, %arg3 : tensor<16x16xi8>, i32 -> tensor<4x16xi8>
        %19 = routing.routingroutinggatherout tilelist = %14, tensordata = %18 : i32, tensor<4x16xi8> -> tensor<4x16xi8>
        %20 = routing.routingcreatehwiowithtarget targettilelist = %14 : i32 {direction = "output", iotype = "mem2"} -> i32
        %21 = routing.routingmovedatabyio tensordata = %19, hwiowithtarget = %20 : tensor<4x16xi8>, i32 -> i32
        "routing.yield"() : () -> ()
      }
