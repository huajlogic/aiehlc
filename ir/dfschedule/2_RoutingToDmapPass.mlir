  ...
  func.func @main(%arg0: memref<512x512xi8>, %arg1: memref<512x512xi8>, %arg2: memref<512x512xi8>) {
    ...
    scf.execute_region {
      ...
      ^bb0(%arg3: i32):
        ...
        dmap.push %11 : tensor<128x512xi8> to %17 : !dmap.dmapportstream
        "routing.yield"() : () -> ()
      }
    ...
    scf.execute_region {
      ...
      ^bb0(%arg3: i32):
        ...
        dmap.push %12 : tensor<128x512xi8> to %18 : !dmap.dmapportstream
        %19 = routing.routingextract_data %7, %arg3 : tensor<512x512xi8>, i32 -> tensor<128x512xi8>
        ...
        dmap.pull %19 : tensor<128x512xi8> from %25 : !dmap.dmapportstream
        "routing.yield"() : () -> ()
      }
