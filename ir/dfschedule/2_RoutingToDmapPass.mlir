  ...
  func.func @main(%arg0: memref<64x64xi8>, %arg1: memref<64x64xi8>, %arg2: memref<64x64xi8>) {
    ...
    scf.execute_region {
      ...
      ^bb0(%arg3: i32):
        ...
        dmap.push %11 : tensor<16x64xi8> to %17 : !dmap.dmapportstream
        "routing.yield"() : () -> ()
      }
    ...
    scf.execute_region {
      ...
      ^bb0(%arg3: i32):
        ...
        dmap.push %12 : tensor<16x64xi8> to %18 : !dmap.dmapportstream
        %19 = routing.routingextract_data %7, %arg3 : tensor<64x64xi8>, i32 -> tensor<16x64xi8>
        ...
        dmap.pull %19 : tensor<16x64xi8> from %25 : !dmap.dmapportstream
        "routing.yield"() : () -> ()
      }
