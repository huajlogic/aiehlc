module attributes {codegen.headers = ["stdint.h", "stdio.h", "custom_lib.h"], routing.pp_depth_map = {tensor_0 = 2 : i32, tensor_1 = 2 : i32, tensor_2 = 2 : i32}} {
  ...
  emitc.verbatim "#include \22mul2.cc\22"
  emitc.verbatim "// kernel_decl mul2"
  emitc.func @main() -> i32 {
    ...
    emitc.verbatim "window_init(window_window_out_0, 1, buf_out_ping_0, LOCK_window_out_0_ACQ, buf_out_pong_0, LOCK_window_out_0_REL, 512, 2);"
    emitc.verbatim "// kernel_invoke mul2"
    emitc.verbatim "mul2(get_input_async_window_int8(window_window_in_0), get_input_async_window_int8(window_window_in_1), get_output_async_window_int8(window_window_out_0));"
    emitc.verbatim "done();"
