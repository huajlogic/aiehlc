module attributes {codegen.headers = ["stdint.h", "stdio.h", "custom_lib.h"], routing.effective_k = 16 : i64, routing.full_k = 64 : i64, routing.k_rounds = 4 : i64, routing.m_rounds = 2 : i64, routing.n_rounds = 2 : i64, routing.pp_depth_map = {tensor_0 = 2 : i32, tensor_1 = 2 : i32, tensor_2 = 2 : i32}, routing.tile_cols = 16 : i64, routing.tile_m = 8 : i64, routing.tile_n = 8 : i64, routing.tile_rows = 16 : i64} {
  ...
  emitc.verbatim "#define BUF_SZ_IN_0 32"
  emitc.verbatim "#define BUF_SZ_IN_1 32"
  emitc.verbatim "#define BUF_SZ_OUT_0 32"
  emitc.verbatim "#define BUF_SZ 32"
  ...
  emitc.verbatim "v4int8 buf_in_ping_0[32];"
  emitc.verbatim "v4int8 buf_in_pong_0[32];"
  ...
  emitc.verbatim "v4int8 buf_in_ping_1[32];"
  emitc.verbatim "v4int8 buf_in_pong_1[32];"
  ...
  emitc.verbatim "v4int8 buf_out_ping_0[32];"
  emitc.verbatim "v4int8 buf_out_pong_0[32];"
  ...
  emitc.func @main() -> i32 {
    ...
    emitc.verbatim "window_init(window_window_in_0, 1, buf_in_ping_0, LOCK_window_in_0_ACQ, buf_in_pong_0, LOCK_window_in_0_REL, 32, 8);"
    emitc.verbatim "window_internal window_window_in_1[1];"
    emitc.verbatim "window_init(window_window_in_1, 1, buf_in_ping_1, LOCK_window_in_1_ACQ, buf_in_pong_1, LOCK_window_in_1_REL, 32, 8);"
    emitc.verbatim "window_internal window_window_out_0[1];"
    emitc.verbatim "window_init(window_window_out_0, 1, buf_out_ping_0, LOCK_window_out_0_ACQ, buf_out_pong_0, LOCK_window_out_0_REL, 32, 2);"
