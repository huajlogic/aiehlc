module attributes {codegen.headers = ["stdint.h", "stdio.h", "custom_lib.h"], routing.pp_depth_map = {tensor_0 = 2 : i32, tensor_1 = 2 : i32, tensor_2 = 1 : i32}} {
  ...
  dfschedule.host @host_canonicalized {
    ...
    %206 = dfschedule.schedule.start_io(%184, %205) {flow_index = 17 : i32, repeat_count = 8 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    ...
    %238 = dfschedule.schedule.start_io(%208, %237) {flow_index = 18 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    ...
    %265 = dfschedule.schedule.start_io(%243, %264) {flow_index = 19 : i32, repeat_count = 8 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    ...
    %297 = dfschedule.schedule.start_io(%267, %296) {flow_index = 20 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    ...
    %324 = dfschedule.schedule.start_io(%302, %323) {flow_index = 21 : i32, repeat_count = 8 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    ...
    %356 = dfschedule.schedule.start_io(%326, %355) {flow_index = 22 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    ...
    %383 = dfschedule.schedule.start_io(%361, %382) {flow_index = 23 : i32, repeat_count = 8 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %384 = dfschedule.declare_kernel_config @kernelconfig_merged0 {tile_configs = [{acquire_lock_id = 2 : i32, buffer_mode = 1 : i32, buffer_offset = 0 : i32, buffer_size = 4096 : i32, dma_channel = 1 : i32, element_size = 1 : i32, flow_index = 12 : i32, num_buffers = 2 : i32, num_iterations = 4 : i32, packet_id = 0 : i32, release_lock_id = 3 : i32, tile_index = 0 : i32}]}
    ...
    %388 = dfschedule.declare_kernel_config @kernelconfig_merged4 {tile_configs = [{acquire_lock_id = 2 : i32, buffer_mode = 1 : i32, buffer_offset = 0 : i32, buffer_size = 4096 : i32, dma_channel = 1 : i32, element_size = 1 : i32, flow_index = 13 : i32, num_buffers = 2 : i32, num_iterations = 4 : i32, packet_id = 0 : i32, release_lock_id = 3 : i32, tile_index = 0 : i32}]}
    ...
    %392 = dfschedule.declare_kernel_config @kernelconfig_merged8 {tile_configs = [{acquire_lock_id = 2 : i32, buffer_mode = 1 : i32, buffer_offset = 0 : i32, buffer_size = 4096 : i32, dma_channel = 1 : i32, element_size = 1 : i32, flow_index = 14 : i32, num_buffers = 2 : i32, num_iterations = 4 : i32, packet_id = 0 : i32, release_lock_id = 3 : i32, tile_index = 0 : i32}]}
    ...
    %402 = dfschedule.schedule.start_io(%9, %10) {flow_index = 12 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %403 = dfschedule.schedule.start_io(%17, %18) {flow_index = 12 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %404 = dfschedule.schedule.start_io(%25, %26) {flow_index = 12 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %405 = dfschedule.schedule.start_io(%33, %34) {flow_index = 12 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %406 = dfschedule.schedule.start_io(%46, %47) {flow_index = 13 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %407 = dfschedule.schedule.start_io(%54, %55) {flow_index = 13 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %408 = dfschedule.schedule.start_io(%62, %63) {flow_index = 13 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %409 = dfschedule.schedule.start_io(%70, %71) {flow_index = 13 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %410 = dfschedule.schedule.start_io(%83, %84) {flow_index = 14 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %411 = dfschedule.schedule.start_io(%91, %92) {flow_index = 14 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %412 = dfschedule.schedule.start_io(%99, %100) {flow_index = 14 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %413 = dfschedule.schedule.start_io(%107, %108) {flow_index = 14 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %414 = dfschedule.schedule.start_io(%120, %121) {flow_index = 15 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %415 = dfschedule.schedule.start_io(%128, %129) {flow_index = 15 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %416 = dfschedule.schedule.start_io(%136, %137) {flow_index = 15 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %417 = dfschedule.schedule.start_io(%144, %145) {flow_index = 15 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %418 = dfschedule.schedule.start_io(%155, %156) {flow_index = 16 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %419 = dfschedule.schedule.start_io(%162, %163) {flow_index = 16 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %420 = dfschedule.schedule.start_io(%169, %170) {flow_index = 16 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %421 = dfschedule.schedule.start_io(%176, %177) {flow_index = 16 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %422 = dfschedule.schedule.start_io(%188, %189) {flow_index = 17 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %423 = dfschedule.schedule.start_io(%193, %194) {flow_index = 17 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %424 = dfschedule.schedule.start_io(%198, %199) {flow_index = 17 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %425 = dfschedule.schedule.start_io(%203, %204) {flow_index = 17 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %426 = dfschedule.schedule.start_io(%214, %215) {flow_index = 18 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %427 = dfschedule.schedule.start_io(%221, %222) {flow_index = 18 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %428 = dfschedule.schedule.start_io(%228, %229) {flow_index = 18 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %429 = dfschedule.schedule.start_io(%235, %236) {flow_index = 18 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %430 = dfschedule.schedule.start_io(%247, %248) {flow_index = 19 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %431 = dfschedule.schedule.start_io(%252, %253) {flow_index = 19 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %432 = dfschedule.schedule.start_io(%257, %258) {flow_index = 19 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %433 = dfschedule.schedule.start_io(%262, %263) {flow_index = 19 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %434 = dfschedule.schedule.start_io(%273, %274) {flow_index = 20 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %435 = dfschedule.schedule.start_io(%280, %281) {flow_index = 20 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %436 = dfschedule.schedule.start_io(%287, %288) {flow_index = 20 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %437 = dfschedule.schedule.start_io(%294, %295) {flow_index = 20 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %438 = dfschedule.schedule.start_io(%306, %307) {flow_index = 21 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %439 = dfschedule.schedule.start_io(%311, %312) {flow_index = 21 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %440 = dfschedule.schedule.start_io(%316, %317) {flow_index = 21 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %441 = dfschedule.schedule.start_io(%321, %322) {flow_index = 21 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %442 = dfschedule.schedule.start_io(%332, %333) {flow_index = 22 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %443 = dfschedule.schedule.start_io(%339, %340) {flow_index = 22 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %444 = dfschedule.schedule.start_io(%346, %347) {flow_index = 22 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %445 = dfschedule.schedule.start_io(%353, %354) {flow_index = 22 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %446 = dfschedule.schedule.start_io(%365, %366) {flow_index = 23 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %447 = dfschedule.schedule.start_io(%370, %371) {flow_index = 23 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %448 = dfschedule.schedule.start_io(%375, %376) {flow_index = 23 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
    %449 = dfschedule.schedule.start_io(%380, %381) {flow_index = 23 : i32} : (!dfschedule.io_handle, i32) -> !dfschedule.event
