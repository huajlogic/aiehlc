...
#define XIN_IMR_OFFSET                                                                                                 \
    8 /* Interrupt Mode Register , this is present                                                                     \
       *  only for Fast Interrupt */
#define XIN_IVAR_OFFSET                                                                                                \
    64 /* Interrupt Vector Address Register                                                                            \
...
#define XIN_IMR_OFFSET                                                                                                 \
    32                    /* Interrupt Mode Register , this is present                                                 \
                           *  only for Fast Interrupt */
#define XIN_ILR_OFFSET 36 /* Interrupt level register */
#define XIN_IVAR_OFFSET                                                                                                \
    0x100 /* Interrupt Vector Address Register                                                                         \
           * Interrupt 0 Offset, this is present                                                                       \
           * only for Fast Interrupt */
#define XIN_IVEAR_OFFSET                                                                                               \
    0x200 /* Interrupt Vector Extended Address                                                                         \
Register */
...
#define XIntc_MasterEnable(BaseAddress)                                                                                \
    XIntc_Out32((BaseAddress) + XIN_MER_OFFSET, XIN_INT_MASTER_ENABLE_MASK | XIN_INT_HARDWARE_ENABLE_MASK)
...
#define XIntc_GetIntrStatus(BaseAddress)                                                                               \
    (XIntc_In32((BaseAddress) + XIN_ISR_OFFSET) & XIntc_In32((BaseAddress) + XIN_IER_OFFSET))
