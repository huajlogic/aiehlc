...
typedef struct {
    ...
    u32 Options;          /**< Device option
                               XIN_SVC_SGL_ISR_OPTION - Primary interrupt handler services the highest priority pending interrupt
                             and return          XIN_SVC_ALL_ISRS_OPTION  - Primary interrupt handler services all of the pending
