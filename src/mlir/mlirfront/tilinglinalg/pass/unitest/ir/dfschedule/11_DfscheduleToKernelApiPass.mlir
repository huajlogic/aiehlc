module attributes {codegen.headers = ["stdint.h", "stdio.h", "custom_lib.h"]} {
  ...
  emitc.verbatim "v4int8 buf_in_ping_0[BUF_SZ];"
  emitc.verbatim "v4int8 buf_in_pong_0[BUF_SZ];"
  ...
  emitc.verbatim "v4int8 buf_in_ping_1[BUF_SZ];"
  emitc.verbatim "v4int8 buf_in_pong_1[BUF_SZ];"
  ...
  emitc.func @main() -> i32 {
    ...
    emitc.verbatim "window_init(window_window_in_0, 1, buf_in_ping_0, LOCK_window_in_0_ACQ, buf_in_pong_0, LOCK_window_in_0_REL, BUF_SZ, BUF_SZ);"
    emitc.verbatim "window_internal window_window_in_1[1];"
    emitc.verbatim "window_init(window_window_in_1, 1, buf_in_ping_1, LOCK_window_in_1_ACQ, buf_in_pong_1, LOCK_window_in_1_REL, BUF_SZ, BUF_SZ);"
