  ...
  func.func @main(%arg0: memref<16x16xi8>, %arg1: memref<16x16xi8>, %arg2: memref<16x16xi8>) {
    ...
    scf.execute_region {
      ...
      ^bb0(%arg3: i32):
        ...
        dmaphop.push %11 into %35 consumer(%11, %11, %11, %11 at %13, %16, %19, %22) : tensor<4x16xi8> !dmaphop.path tensor<4x16xi8>, tensor<4x16xi8>, tensor<4x16xi8>, tensor<4x16xi8> !dmaphop.port, !dmaphop.port, !dmaphop.port, !dmaphop.port
        dmaphop.sync %35
        "routing.yield"() : () -> ()
      }
    ...
    scf.execute_region {
      ...
      ^bb0(%arg3: i32):
        ...
        dmaphop.push %12 into %36 consumer(%12, %12, %12, %12 at %14, %17, %20, %23) : tensor<4x16xi8> !dmaphop.path tensor<4x16xi8>, tensor<4x16xi8>, tensor<4x16xi8>, tensor<4x16xi8> !dmaphop.port, !dmaphop.port, !dmaphop.port, !dmaphop.port
        dmaphop.sync %36
        %37 = routing.routingextract_data %7, %arg3 : tensor<16x16xi8>, i32 -> tensor<4x16xi8>
        %38 = dmaphop.tile{TILETYPE = "core", col = 0, row = 3} -> !dmaphop.tile
        %39 = dmaphop.port @f5_corePortIn0 on %38 { direction = "In", direction_channel = 0 } : !dmaphop.tile -> !dmaphop.port
        ...
        %42 = dmaphop.port @f5_corePortIn1 on %41 { direction = "In", direction_channel = 0 } : !dmaphop.tile -> !dmaphop.port
        ...
        %45 = dmaphop.port @f5_corePortIn2 on %44 { direction = "In", direction_channel = 0 } : !dmaphop.tile -> !dmaphop.port
        ...
        %extracted_slice = tensor.extract_slice %37[0, 0] [1, 16] [1, 1] {tag = "producer0"} : tensor<4x16xi8> to tensor<1x16xi8>
        %extracted_slice_0 = tensor.extract_slice %37[1, 0] [1, 16] [1, 1] {tag = "producer1"} : tensor<4x16xi8> to tensor<1x16xi8>
        %extracted_slice_1 = tensor.extract_slice %37[2, 0] [1, 16] [1, 1] {tag = "producer2"} : tensor<4x16xi8> to tensor<1x16xi8>
        %extracted_slice_2 = tensor.extract_slice %37[3, 0] [1, 16] [1, 1] {tag = "producer3"} : tensor<4x16xi8> to tensor<1x16xi8>
        dmaphop.pull %37 from %61 producer(%extracted_slice, %extracted_slice_0, %extracted_slice_1, %extracted_slice_2 at %39, %42, %45, %48) : tensor<4x16xi8> !dmaphop.path tensor<1x16xi8>, tensor<1x16xi8>, tensor<1x16xi8>, tensor<1x16xi8> !dmaphop.port, !dmaphop.port, !dmaphop.port, !dmaphop.port
        dmaphop.sync %61
        "routing.yield"() : () -> ()
      }
      ...
      ^bb0(%arg3: i32):
        ...
        %39 = dmaphop.port @f7_corePortIn0 on %38 { direction = "In", direction_channel = 0 } : !dmaphop.tile -> !dmaphop.port
        ...
        %42 = dmaphop.port @f7_corePortIn1 on %41 { direction = "In", direction_channel = 0 } : !dmaphop.tile -> !dmaphop.port
        ...
        %45 = dmaphop.port @f7_corePortIn2 on %44 { direction = "In", direction_channel = 0 } : !dmaphop.tile -> !dmaphop.port
      ...
      ^bb0(%arg3: i32):
        ...
        %39 = dmaphop.port @f9_corePortIn0 on %38 { direction = "In", direction_channel = 0 } : !dmaphop.tile -> !dmaphop.port
        ...
        %42 = dmaphop.port @f9_corePortIn1 on %41 { direction = "In", direction_channel = 0 } : !dmaphop.tile -> !dmaphop.port
        ...
        %45 = dmaphop.port @f9_corePortIn2 on %44 { direction = "In", direction_channel = 0 } : !dmaphop.tile -> !dmaphop.port
      ...
      ^bb0(%arg3: i32):
        ...
        %39 = dmaphop.port @f11_corePortIn0 on %38 { direction = "In", direction_channel = 0 } : !dmaphop.tile -> !dmaphop.port
        ...
        %42 = dmaphop.port @f11_corePortIn1 on %41 { direction = "In", direction_channel = 0 } : !dmaphop.tile -> !dmaphop.port
        ...
        %45 = dmaphop.port @f11_corePortIn2 on %44 { direction = "In", direction_channel = 0 } : !dmaphop.tile -> !dmaphop.port
