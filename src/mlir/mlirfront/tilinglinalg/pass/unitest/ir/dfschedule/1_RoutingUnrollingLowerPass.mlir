module attributes {codegen.headers = ["stdint.h", "stdio.h", "custom_lib.h"]} {
  func.func @main(%arg0: memref<16x16xi8>, %arg1: memref<16x16xi8>, %arg2: memref<16x16xi8>) {
    ...
    scf.execute_region {
      ...
      ^bb0(%arg3: i32):
        %13 = routing.routingextract_data %8, %arg3 : tensor<16x16xi8>, i32 -> tensor<4x16xi8>
        %14 = routing.routingextract_tiles %7, %arg3 : i32, i32 -> i32
        %15 = routing.routingcreatehwiowithtarget targettilelist = %14 : i32 {direction = "input", iotype = "mem2"} -> i32
        %16 = routing.routingmovedatabyio tensordata = %13, hwiowithtarget = %15 : tensor<4x16xi8>, i32 -> i32
        "routing.yield"() : () -> ()
      }
      ...
      %11 = routing.RoutingCreate<Memo = "row"> ( scf_idx = %c2_i32 : i32) -> i32{
      ^bb0(%arg3: i32):
        %13 = routing.routingextract_data %8, %arg3 : tensor<16x16xi8>, i32 -> tensor<4x16xi8>
        %14 = routing.routingextract_tiles %7, %arg3 : i32, i32 -> i32
        %15 = routing.routingcreatehwiowithtarget targettilelist = %14 : i32 {direction = "input", iotype = "mem2"} -> i32
      ...
      %12 = routing.RoutingCreate<Memo = "row"> ( scf_idx = %c3_i32 : i32) -> i32{
      ^bb0(%arg3: i32):
        %13 = routing.routingextract_data %8, %arg3 : tensor<16x16xi8>, i32 -> tensor<4x16xi8>
        %14 = routing.routingextract_tiles %7, %arg3 : i32, i32 -> i32
        %15 = routing.routingcreatehwiowithtarget targettilelist = %14 : i32 {direction = "input", iotype = "mem2"} -> i32
    ...
    scf.execute_region {
      ...
      ^bb0(%arg3: i32):
        %13 = routing.routingextract_data %8, %arg3 : tensor<16x16xi8>, i32 -> tensor<4x16xi8>
        %14 = routing.routingextract_tiles %7, %arg3 : i32, i32 -> i32
        %15 = routing.routingroutinggatherout tilelist = %14, tensordata = %13 : i32, tensor<4x16xi8> -> tensor<4x16xi8>
        %16 = routing.routingcreatehwiowithtarget targettilelist = %14 : i32 {direction = "output", iotype = "mem2"} -> i32
        %17 = routing.routingmovedatabyio tensordata = %15, hwiowithtarget = %16 : tensor<4x16xi8>, i32 -> i32
        "routing.yield"() : () -> ()
      }
      %10 = routing.RoutingCreate<Memo = "row"> ( scf_idx = %c1_i32 : i32) -> i32{
      ^bb0(%arg3: i32):
