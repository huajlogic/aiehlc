...
//
// Matches pipeline: BUF_SZ=16 (64 bytes), 2 symmetric iterations
// Output DMA BD len=8 (32 bytes per cycle), ping-pong = 64 bytes total
// Iter 0: cache A0,B0, write C[0:3,0:3] + zeros → 32 bytes
// Iter 1: compute C[4:7,0:3] and C[4:7,4:7] → 32 bytes
#define K_DIM 16
